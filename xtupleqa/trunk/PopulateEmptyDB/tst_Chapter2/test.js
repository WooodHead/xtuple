...
function main()
{
    ...
    //---------------Create Inventory - new Cost Catergory------------
     ...
     try{
         ...
         if(!clickItem(":List Class Codes._classcode_XTreeWidget", "TOY-TRUCKS", 5, 5, 1, Qt.LeftButton))             test.pass("Class Code: TOY-TRUCKS created");
         waitForObject(":List Class Codes.New_QPushButton_2");
         clickButton(":List Class Codes.New_QPushButton_2");
         waitForObject(":_classCode_XLineEdit_2");
     ...
     }catch(e){test.fail("Exception in defining Class Code");}
     ...
     }catch(e){test.fail("Exception in defining Product Category");}
     ...
     }catch(e){test.fail("Exception in creating Freight Classes");}
   ...
   if(appEdition=="Manufacturing")
   {
         ...
         }catch(e){test.fail("Exception in defining Site Calendar Exception");}
     }
     else if(appEdition=="PostBooks")
     {
         try{
