...

    {
        ...
        try
        {
            ...
            if(appEdition=="Manufacturing")
            {
                ...
                waitForObject(":_listTab.Anna_QModelIndex");
                mouseClick(":_listTab.Anna_QModelIndex", 23, 7, 0, Qt.LeftButton);;
            }
            else
            {
            ...
            if(object.exists("{column='0' container=':_list_XTreeWidget_7' text='ZENPROSPECT' type='QModelIndex'}"))   
        ...
        try
        {
            ...
            waitForObject(":_list_XTreeWidget_5");
            doubleClickItem(":_list_XTreeWidget_5",x , 5, 5, 0, Qt.LeftButton);
            waitForObject(":Sales Order.qt_tabwidget_tabbar_QTabBar");
    ...
    //    }
        ...
        var qty=queryQoh("YTRUCK1","WH1");
        var qtylot=queryQoh("ZTRUCK1","WH1");
        var qtyloc=queryQoh("WTRUCK1","WH1");
        var qtyser=queryQoh("STRUCK1","WH1");
        var qtyTWHEEL1=queryQoh("TWHEEL1","WH1");
        var qtyCBODY1=queryQoh("CBODY1","WH1");
        var qtyHUB1=queryQoh("HUB1","WH1");
        var qtyCBUMP=queryQoh("CBUMP","WH1");
        var qtyret=queryQoh("BTRUCK1","WH1");
        ...
        var result=queryQoh("ZTRUCK1","WH1");
        ...
        var result=queryQoh("WTRUCK1","WH1");
        ...
        var result=queryQoh("STRUCK1","WH1");
        ...
        var result=queryQoh("CBODY1","WH1");
        ...
        var result=queryQoh("BTRUCK1","WH1");
