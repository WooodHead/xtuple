            ...
            function main()
            {
              ...
              var qty1=queryQoh("TWHEEL1","WH1");
                ...
                var result3=queryQoh(soitem,"WH1");
                if((qty3==result3))
             ...
             //-----Verification of G/L transaction for Shipping the Sales Order -----
                ...
                try{
                    ...
                    waitForObject(":_list_XTreeWidget_3");
                    if(object.exists("{column='0' container=':_list_XTreeWidget_3' text='"+wonumber+"' type='QModelIndex'}"))  
