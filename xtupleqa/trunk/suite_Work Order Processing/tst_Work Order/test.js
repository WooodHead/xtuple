    function main()
    {
      ...
      //  -----Editing of preferences----
        ...
        try
        {
            ...
            if(object.exists("{column='0' container=':_list_XTreeWidget_3' text='TTOOL1' type='QModelIndex'}"))
                test.pass("Item Created: TTOOL1");
            else 
                test.fail("Item not created: TTOOL1");
        ...
        {
            test.fail("Exception in creating item TTOOL1:"+e);
        }
        ...
        try{
            ...
            type(":Item Site.ItemLineEdit_ItemLineEdit", "TTOOL1");
            nativeType("<Tab>");   
            ...
            waitForObject(":_list_XTreeWidget_3");
            if(object.exists("{column='1' container=':_list_XTreeWidget_3' text='TTOOL1' type='QModelIndex'}"))
                test.pass("Item Site Created for: TTOOL1");
            else 
                test.fail("Item Site not created for: TTOOL1");
        ...
        var wonumtool = createWorkOrder("TTOOL1", toolqty); //---- WO for Tooling Item
        ...
        try{
            ...
            var qtybody=queryQoh("TBODY1","WH1");
            snooze(0.5);
            var qtyypaint=queryQoh("YPAINT1", "WH1");
            snooze(0.5);
            var qtywheel=queryQoh("TWHEEL1", "WH1");
            snooze(0.5);
            var qtysub=queryQoh("TSUB1", "WH1");
            snooze(0.5);
        ...
        issueItem(wonumreg, "YPAINT1");
        snooze(0.5);
        issueItem(wonumreg, "TBODY1");
        snooze(0.5);
        issueItem(wonumreg, "TSUB1");
        snooze(0.5);
        issueItem(wonumreg, "TWHEEL1");
        snooze(0.5);
        
        //-----Verification of updated QOH by Item (After issuing the materials to the WO)-----   
        
        try{
            var result=queryQoh("TWHEEL1", "WH1");
        ...
        try{
            ...
            var qtyytruck=queryQoh("YTRUCK1", "WH1");
            snooze(0.5);
        ...
        try{
            ...
            qtyytruck=queryQoh("YTRUCK1", "WH1");
            snooze(0.5);
        ...
        try{
            ...
            qtybody=queryQoh("TBODY1", "WH1");
            snooze(0.5);
            var qtywpaint=queryQoh("WPAINT1", "WH1");
            snooze(0.5);
            qtywheel=queryQoh("TWHEEL1", "WH1");
            snooze(0.5);
            qtysub=queryQoh("TSUB1", "WH1");
            test.log("QOH verified successfuly before issuing the materials to the Work Order");
        }
        catch(e)
        {
        ...
        issueBatch(wonummlc, "WTRUCK1");
        
        //-----Verification of updated QOH by Item (After issuing the materials to the WO)-----   
        
        try{
            result=queryQoh("TWHEEL1", "WH1");
        ...
        try{
            ...
            var qtywtruck=queryQoh("WTRUCK1", "WH1");
            snooze(0.5);
        ...
        try{
            ...
            mouseClick(":_frame._itemloc_XTreeWidget_3", 24, 3, 0, Qt.LeftButton);
        ...
        try{
            ...
            qtywtruck=queryQoh("WTRUCK1", "WH1");
            snooze(0.5);
        ...
        try{
            ...
            mouseClick(":_frame._itemloc_XTreeWidget", 73, 7, 0, Qt.LeftButton);
            waitForObject(":Issue to Shipping.Distribute_QPushButton");
            clickButton(":Issue to Shipping.Distribute_QPushButton");
            waitForObject(":Issue to Shipping.Distribute_QPushButton");
            clickButton(":Issue to Shipping.Distribute_QPushButton");
        ...
        issueBatch(wonumregular, "YTRUCK1");
        ...
        postProductionim(wonumregular, postqty); 
        ...
        postProductionim(wonumregular, postqty);  //-----Verification of updated QOH by Item (after 2nd post production)-----   
        ...
        //----- PostProduction of a Work Order (3rd Time)of regular type Item------
        
        postProductionim(wonumregular, post2qty);  //-----Updated  QOH Verification (after 3rd post production)-----   
        ...
        try{
            ...
            waitForObject(":_bom.YTRUCK1_QModelIndex");
            doubleClick(":_bom.YTRUCK1_QModelIndex", 26, 4, 0, Qt.LeftButton);
            waitForObject(":_bomitem.TSUB1_QModelIndex");
            mouseClick(":_bomitem.TSUB1_QModelIndex", 14, 8, 0, Qt.LeftButton);
        ...
        var qtybox=queryQoh("TBOX1", "WH1");
        snooze(0.5);
        var qtyinsert=queryQoh("TINSERT1", "WH1");
        snooze(0.5);
        qtysub=queryQoh("TSUB1", "WH1");
        
        //----- Post Production for the Indented WO---
        
        postProductionim(wonumindent1, woqty)
                
                //-----Verification of updated QOH by Item (After issuing the materials to the WO)-----   
                
                result=queryQoh("TBOX1", "WH1");
        ...
        qtybody=queryQoh("TBODY1", "WH1");
        snooze(0.5);
        qtyypaint=queryQoh("YPAINT1", "WH1");
        snooze(0.5);
        qtywheel=queryQoh("TWHEEL1", "WH1");
        snooze(0.5);
        qtysub=queryQoh("TSUB1", "WH1");
        ...
        //----Issuing materials by Batch------
        issueBatch(wonumindent, "YTRUCK1");
        ...
        postProductionim(wonumindent, woqty); // if you get any error here declare regqty as variable and assign some value to it..
        ...
        if((qtyytruck+parseInt(woqty)==result))
            test.pass("Quantity of YTRUCK11 is updated correctly after 1st Post Production");
        else
