function executeChapter5()
{
    ...
    waitForObject(":_description1_XLineEdit_10");
    type(":_description1_XLineEdit_10", "<Ctrl+A>");
    type(":_description1_XLineEdit_10", "<Del>");
    type(":_description1_XLineEdit_10", "Red Collector’s Truck");
    type(":Item._description2_XLineEdit_9", "<Ctrl+A>");
    type(":Item._description2_XLineEdit_9", "<Del>");
    type(":Item._description2_XLineEdit_9", "Truck Type 1");
    type(":_itemGroup._planningType_QComboBox_10", "MPS");
    clickButton(":Item.Save_QPushButton_14");
    
    waitForObject(":List Items._item_XTreeWidget_3");
    doubleClickItem(":List Items._item_XTreeWidget_3", "BTRUCK1", 5, 5, 1, Qt.LeftButton);
    waitForObject(":_description1_XLineEdit_11");
    type(":_description1_XLineEdit_11", "<Ctrl+A>");
    type(":_description1_XLineEdit_11", "<Del>");
    type(":_description1_XLineEdit_11", "Blue Collector’s Truck");
    type(":Item._description2_XLineEdit_10", "<Ctrl+A>");
    type(":Item._description2_XLineEdit_10", "<Del>");
    type(":Item._description2_XLineEdit_10", "Truck Type 1");
    type(":_itemGroup._planningType_QComboBox_11", "MPS");
    clickButton(":Item.Save_QPushButton_15");
        
    waitForObject(":List Items._item_XTreeWidget_3");
    doubleClickItem(":List Items._item_XTreeWidget_3", "WTRUCK1", 5, 5, 1, Qt.LeftButton);
    waitForObject(":_description1_XLineEdit_12");
    type(":_description1_XLineEdit_12", "<Ctrl+A>");
    type(":_description1_XLineEdit_12", "<Del>");
    type(":_description1_XLineEdit_12", "White Collector’s Truck");
    type(":Item._description2_XLineEdit_11", "<Ctrl+A>");
    type(":Item._description2_XLineEdit_11", "<Del>");
    type(":Item._description2_XLineEdit_11", "Truck Type 1");
    type(":_itemGroup._planningType_QComboBox_12", "MPS");
    clickButton(":Item.Save_QPushButton_16");
