    function main()
    {
      ...
      source(findFile("scripts","functions.js"));
       ...
       //-----------Inventory setup------------
        ...
        clickItem(":_toNumGeneration_QComboBox", "Automatic",0,0,1,Qt.LeftButton);
        ...
        clickItem(":_itemtype_XComboBox_2","Tooling",5,5, 0, Qt.LeftButton);
        ...
        {
            mouseClick(":xTuple ERP:*.Item is Sold_QGroupBox", 62, 7, 0, Qt.LeftButton);
        }
        ...
        waitForObject(":_warehouse_WComboBox_2");
        clickItem(":_warehouse_WComboBox_2","WH2",5,5, 0, Qt.LeftButton);
        waitForObject(":_plannerCode_XComboBox_3");
        clickItem(":_plannerCode_XComboBox_3","MRP-MRP Items",5,5, 0, Qt.LeftButton);
        waitForObject(":_plannerCode_XComboBox_3");
        clickItem(":_plannerCode_XComboBox_3","MRP-MRP Items",5,5, 0, Qt.LeftButton);
      ...
      //-------Create item site for YPAINT2 in WH2----------
        try
        {
            ...
            waitForObject(":_warehouse_WComboBox_2");
            clickItem(":_warehouse_WComboBox_2","WH2", 22, 11, 0, Qt.LeftButton);
            waitForObject(":Select Order for Billing.Save_QPushButton");
            clickButton(":Select Order for Billing.Save_QPushButton");
        ...
        catch(e)
        {
            ...
            var lotQohWh1 = queryQoh("YPAINT1","WH1");
            var lotQohWh2 = queryQoh("YPAINT1","WH2");
            var regQohWh1 = queryQoh("YTRUCK1","WH1");
            var regQohWh2 = queryQoh("YTRUCK1","WH2");
            var mlcQohWh1 = queryQoh("WTRUCK1","WH1");
            var mlcQohWh2 = queryQoh("WTRUCK1","WH2");
            var serialQohWh1 = queryQoh("STRUCK1","WH1");
            var serialQohWh2 = queryQoh("STRUCK1","WH2");
            var toolQohWh1 = adjustQoh("TTOOL1","100","WH1","");
            var toolQohWh2 = "0";
    ...
    //-------------------Verification of updated QOH by Item at WH1----
     ...
     //-----------------------------Receive inventory for Transfer Orders---------------------------   
        ...
        //-------------------Verification of updated QOH by Item at WH2----
          ...
          var result=queryQoh("YTRUCK1","WH2");
        ...
        var drQohwh1 = queryQoh("YTRUCK1","WH1");
        var drQohwh2 = queryQoh("YTRUCK1","WH2");
