        ...
        
{
    ...
    test.log("Updated Actual Costs by Class Code");
    ...
    test.log("Posted Actual Costs by Class Code");
    ...
    test.log("Posted Standard Costs by Class Code");
    ...
    doubleClickItem(":_listTab_XTreeWidget_8", "John", 5, 5, 0, Qt.LeftButton);
