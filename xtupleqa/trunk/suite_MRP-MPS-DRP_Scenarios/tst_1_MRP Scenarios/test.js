    ...
    try
    {
        ...
        if(iNumberOfRootItems>0)
            ...
            if(iNumberOfRootItems==1)
            {
                ...
                Qnty = obj_TreeTopLevelItem.text(10);
    ...
    try
    {
        ...
        if(iNumberOfRootItems>0)
        {
            if(iNumberOfRootItems==1)
            {
                ...
                obj_TreeTopLevelItem = obj_TreeRootItem.child(0);
                if(obj_TreeTopLevelItem.text(4)=="TBOX1" && obj_TreeTopLevelItem.text(10)=="1,023.00")
                    test.pass("Expected Planned Order generated");
                else 
                    test.fail("Incorrect Planned Order generated");
    ...
    try
    {
        ...
        if(iNumberOfRootItems>0)
        {
            if(iNumberOfRootItems==1)
            {
                ...
                obj_TreeTopLevelItem = obj_TreeRootItem.child(0);
                if(obj_TreeTopLevelItem.text(4)=="TBOX1" && obj_TreeTopLevelItem.text(10)=="50.00")
                    test.pass("Expected Planned Order generated");
                else 
                    test.fail("Incorrect Planned Order generated");
