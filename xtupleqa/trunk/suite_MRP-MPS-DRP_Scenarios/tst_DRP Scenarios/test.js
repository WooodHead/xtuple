function main()
{
    ...
    clickItem(":_itemSite_XTreeWidget", "TWHEEL1", 0, 0, 1, Qt.LeftButton);
    waitForObject(":_frame.Copy_QPushButton");
    clickButton(":_frame.Copy_QPushButton");
    waitForObjectItem(":_warehouse_WComboBox_3", "WH2");
    clickItem(":_warehouse_WComboBox_3", "WH2", 0, 0, 1, Qt.LeftButton);
    ...
    if(iNumberOfRootItems>0)
    {
        if(iNumberOfRootItems==5)
        {
            ...
            obj_TreeTopLevelItem = obj_TreeRootItem.child(0);
            if(obj_TreeTopLevelItem.text(4)=="DTRUCK1" && obj_TreeTopLevelItem.text(1)=="T/O" && obj_TreeTopLevelItem.text(9)=="92.00" && obj_TreeTopLevelItem.text(8)==getForwardDate(3) && obj_TreeTopLevelItem.text(7)==getForwardDate(0))
                test.pass("Expected Planned Order generated");
            else 
                test.fail("Incorrect Planned Order generated");
   ...
   MRP("+99");
    ...
    if(iNumberOfRootItems>0)
    {
        if(iNumberOfRootItems==5)
        {
            ...
            obj_TreeTopLevelItem = obj_TreeRootItem.child(0);
            if(obj_TreeTopLevelItem.text(4)=="DTRUCK1" && obj_TreeTopLevelItem.text(1)=="T/O" && obj_TreeTopLevelItem.text(9)=="192.00" && obj_TreeTopLevelItem.text(8)==getForwardDate(3) && obj_TreeTopLevelItem.text(7)==getForwardDate(0))
                test.pass("Expected Planned Order generated");
            else 
                test.fail("Incorrect Planned Order generated");
