...
class ReportEntity {
    ...
    protected:
        ...
        void drawSelection(QRect rect, QPainter& painter);
...
class ReportEntityField : public Q3CanvasRectangle, public ReportEntity {
    public:
        ...
        int textFlags() const
            { return flags; }
        void setTextFlags(int);
        void setTextFlags(Qt::Alignment alignment, bool wordwrap);
...
// ReportEntityRect
//
class ReportEntityRect : public Q3CanvasRectangle, public ReportEntity {
public:
        ReportEntityRect(ReportWindow *, Q3Canvas * canvas);
        ReportEntityRect(QDomNode & element, ReportWindow *, Q3Canvas * canvas);
