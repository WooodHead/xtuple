...
//
class ReportSection : public QVBox {
    Q_OBJECT
    public:
...
class ReportSectionDetail : public QWidget {
    ...
    protected:
        ...
        QPtrList<ReportSectionDetailGroup> groupList;
...
class ReportResizeBar : public QFrame {
    Q_OBJECT
     public:
         ReportResizeBar(QWidget * parent = 0, const char * name = 0, WFlags f = 0);
         virtual ~ReportResizeBar();
...
//
class ReportCanvas : public QCanvas {
    Q_OBJECT
    public:
...
//
class ReportCanvasView : public QCanvasView {
    Q_OBJECT
    public:
        ReportCanvasView(ReportWindow *, QWidget * parent = 0, const char * name = 0);
        ReportCanvasView(ReportWindow *, QCanvas * canvas, QWidget * parent = 0, const char * name = 0);
