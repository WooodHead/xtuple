...
class ReportHandler : public QObject {
    ...
    public:
        ...
        void docToolBars(QMainWindow * mw, Dock edge = DockTop, bool newLine = FALSE);
        int  populateMenuBar(QMenuBar * menubar, QAction * exitAction = 0);
    ...
    public slots:
        ...
        void editCopy();
        void editPaste();
        void editPaste(ReportWindow *, QCanvas *, const QPoint &);
    ...
    protected:
        ...
        void setSelectedEntity(ReportWindow *, QCanvasItem *);
        void addSelectedEntity(ReportWindow *, QCanvasItem *);
        void updateSelectedEntity();
        unsigned int selectionCount();
        QCanvas * selectionCanvas();
