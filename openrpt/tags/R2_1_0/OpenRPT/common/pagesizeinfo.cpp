...
const QString & PageSizeInfo::name()
{
  return _name;
}

const int PageSizeInfo::qpValue()
{
  return _qpValue;
}
const int PageSizeInfo::width()
{
  return _width;
}
const int PageSizeInfo::height()
{
  return _height;
}

const int PageSizeInfo::area()
{
  return _area;
}

bool PageSizeInfo::isNull()
{
  return _null;
}
