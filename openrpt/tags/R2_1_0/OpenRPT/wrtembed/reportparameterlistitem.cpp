...
#include <qvariant.h>
/*
 *  Constructs a ReportParameterListItem as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  true to construct a modal dialog.
 */
ReportParameterListItem::ReportParameterListItem(QWidget* parent, const char* name, bool modal, Qt::WFlags fl)
