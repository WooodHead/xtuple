...
ReportHandler::ReportHandler(QObject * parent, const char * name)
  : QObject(parent, name) {
    ...
    //Q3PaintDeviceMetrics pdm(qApp->desktop());
    ...
    fileNewAction = new QAction( QPixmap(filenew_xpm),
                                tr("&New"),Qt::CTRL+Qt::Key_N,this,"file new");
    fileOpenAction = new QAction( QPixmap(fileopen_xpm),
                                 tr("&Open..."),Qt::CTRL+Qt::Key_O,this,"file open");
    fileSaveAction = new QAction( QPixmap(filesave_xpm),
                                 tr("&Save"),Qt::CTRL+Qt::Key_S,this,"file save");
    ...
    editCutAction = new QAction( QPixmap(editcut_xpm),
                                tr("Cu&t"), Qt::CTRL+Qt::Key_X, this, "edit cut");
    editCopyAction = new QAction( QPixmap(editcopy_xpm),
                                 tr("&Copy"), Qt::CTRL+Qt::Key_C, this, "edit copy");
    editPasteAction = new QAction( QPixmap(editpaste_xpm),
                                  tr("&Paste"), Qt::CTRL+Qt::Key_V, this, "edit paste");
    editDeleteAction = new QAction( tr("&Delete"), Qt::Key_Delete, this, "edit delete");
    editPreferencesAction = new QAction( tr("Preferences"), 0, this, "edit preferences");

    gridShowAction = new QAction( QPixmap(gridshow_xpm),
                                 tr("Show Grid"), 0, this, "grid show");
    gridShowAction->setCheckable(true);
    gridShowAction->setOn(gridOptions->isVisible());

    gridSnapAction = new QAction( QPixmap(gridsnap_xpm),
                                 tr("Snap Grid"), 0, this, "grid snap");
    gridSnapAction->setCheckable(true);
    gridSnapAction->setOn(gridOptions->isSnap());

    itemLabelAction = new QAction( QPixmap(itemlabel_xpm),
                                  tr("Label"), 0, this, "item label");
    itemFieldAction = new QAction( QPixmap(itemfield_xpm),
                                  tr("Field"), 0, this, "item field");
    itemTextAction = new QAction( QPixmap(itemtext_xpm),
                                 tr("Text"), 0, this, "item text");
    itemLineAction = new QAction( QPixmap(itemline_xpm),
                                 tr("Line"), 0, this, "item line");
    itemBarcodeAction = new QAction( QPixmap(itembarcode_xpm),
                                    tr("Bar Code"), 0, this, "item barcode");
    itemImageAction = new QAction( QPixmap(itemimage_xpm),
                                  tr("Image"), 0, this, "item image");
    itemGraphAction = new QAction( QPixmap(itemgraph_xpm),
                                  tr("Graph"), 0, this, "item graph");

    dbConnectAction = new QAction( strMenuConnect, 0, this, "db connect");
    dbLoadAction = new QAction( tr("Load from DB"), 0, this, "db load");
    dbSaveAction = new QAction( tr("Save to DB"), 0, this, "db save");
...
//
void ReportHandler::docToolBars(Q3MainWindow * mw, Qt::ToolBarDock edge, bool newLine) {
    if(mw) {
        // create the toolbars
        Q3ToolBar * tbFiles = new Q3ToolBar(mw, "file toolbar");
        fileNewAction->addTo(tbFiles);
        fileOpenAction->addTo(tbFiles);
        fileSaveAction->addTo(tbFiles);
    
        Q3ToolBar * tbEdit = new Q3ToolBar(mw, "edit toolbar");
        editCutAction->addTo(tbEdit);
        editCopyAction->addTo(tbEdit);
        editPasteAction->addTo(tbEdit);
    
        Q3ToolBar * tbOptions = new Q3ToolBar(mw, "options toolbar");
        gridShowAction->addTo(tbOptions);
        gridSnapAction->addTo(tbOptions);
    
        Q3ToolBar * tbItems = new Q3ToolBar(mw, "items toolbar");
            ...
            for(i = 0; i < sectionData->selected_items.count(); i++) {
                ...
                switch(sectionData->mouseAction) {
                    case ReportWriterSectionData::MA_Grab:
                        ...
                        break;
                    case ReportWriterSectionData::MA_ResizeNW:
                        if(item->rtti() == ReportEntity::EntityBarcode) ((ReportEntityBarcode*)item)->setSize((int)((item->x() - p.x()) + ((Q3CanvasRectangle*)item)->width()), (int)((item->y() - p.y()) + ((Q3CanvasRectangle*)item)->height()));
                        else ((Q3CanvasRectangle*)item)->setSize((int)((item->x() - p.x()) + ((Q3CanvasRectangle*)item)->width()), (int)((item->y() - p.y()) + ((Q3CanvasRectangle*)item)->height()));
                        item->move(p.x(), p.y());
                        break;
                    case ReportWriterSectionData::MA_ResizeN:
                        if(item->rtti() == ReportEntity::EntityBarcode) ((ReportEntityBarcode*)item)->setSize(((Q3CanvasRectangle*)item)->width(), (int)((item->y() - p.y()) + ((Q3CanvasRectangle*)item)->height()));
                        else ((Q3CanvasRectangle*)item)->setSize(((Q3CanvasRectangle*)item)->width(), (int)((item->y() - p.y()) + ((Q3CanvasRectangle*)item)->height()));
                        item->move((int)(item->x()), p.y());
                        break;
                    case ReportWriterSectionData::MA_ResizeNE:
                        if(item->rtti() == ReportEntity::EntityBarcode) ((ReportEntityBarcode*)item)->setSize((int)(p.x() - item->x()), (int)((item->y() - p.y()) + ((Q3CanvasRectangle*)item)->height()));
                        else ((Q3CanvasRectangle*)item)->setSize((int)(p.x() - item->x()), (int)((item->y() - p.y()) + ((Q3CanvasRectangle*)item)->height()));
                        item->move((int)(item->x()), p.y());
                        break;
                    case ReportWriterSectionData::MA_ResizeE:
                        if(item->rtti() == ReportEntity::EntityBarcode) ((ReportEntityBarcode*)item)->setSize(p.x() - (int)(item->x()), (int)(((Q3CanvasRectangle*)item)->height()));
                        else ((Q3CanvasRectangle*)item)->setSize(p.x() - (int)(item->x()), (int)(((Q3CanvasRectangle*)item)->height()));
                        break;
                    case ReportWriterSectionData::MA_ResizeSE:
                        if(item->rtti() == ReportEntity::EntityBarcode) ((ReportEntityBarcode*)item)->setSize(p.x() - (int)(item->x()), p.y() - (int)(item->y()));
                        else ((Q3CanvasRectangle*)item)->setSize(p.x() - (int)(item->x()), p.y() - (int)(item->y()));
                        break;
                    case ReportWriterSectionData::MA_ResizeS:
                        if(item->rtti() == ReportEntity::EntityBarcode) ((ReportEntityBarcode*)item)->setSize((int)(((Q3CanvasRectangle*)item)->width()), p.y() - (int)(item->y()));
                        else ((Q3CanvasRectangle*)item)->setSize((int)(((Q3CanvasRectangle*)item)->width()), p.y() - (int)(item->y()));
                        break;
                    case ReportWriterSectionData::MA_ResizeSW:
                        if(item->rtti() == ReportEntity::EntityBarcode) ((ReportEntityBarcode*)item)->setSize((int)((item->x()-p.x())+((Q3CanvasRectangle*)item)->width()), (int)(p.y() - item->y()));
                        else ((Q3CanvasRectangle*)item)->setSize((int)((item->x()-p.x())+((Q3CanvasRectangle*)item)->width()), (int)(p.y() - item->y()));
                        item->move(p.x(), item->y());
                        break;
                    case ReportWriterSectionData::MA_ResizeW:
                        if(item->rtti() == ReportEntity::EntityBarcode) ((ReportEntityBarcode*)item)->setSize((int)((item->x()-p.x())+((Q3CanvasRectangle*)item)->width()), (int)((Q3CanvasRectangle*)item)->height());
                        else ((Q3CanvasRectangle*)item)->setSize((int)((item->x()-p.x())+((Q3CanvasRectangle*)item)->width()), (int)((Q3CanvasRectangle*)item)->height());
                        item->move(p.x(), item->y());
                        break;
                    case ReportWriterSectionData::MA_MoveStartPoint:
        ...
        if(it.isElement()) {
            ...
            if(n == "title") {
                ...
                else
                {
                  ...
                  for(unsigned int nodeCounter = 0; nodeCounter < section.count(); nodeCounter++)
                  {
