...
QString listToString(const Q3ValueList<QVariant> &);
Q3ValueList<QVariant> stringToList(const QString &);
...
QString listToString(const Q3ValueList<QVariant> & list)
{
  QString str;
  for(Q3ValueList<QVariant>::ConstIterator it = list.begin(); it != list.end(); ++it)
  {
    if(!str.isEmpty())
      str.append(comma);
...
Q3ValueList<QVariant> stringToList(const QString & str)
{
