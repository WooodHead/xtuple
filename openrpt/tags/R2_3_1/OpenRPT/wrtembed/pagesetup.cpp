...
const char PageSetup::strAvery5263[]   = "Avery 5263";
const char PageSetup::strAvery5264[]   = "Avery 5264";
const char PageSetup::strAvery8460[]   = "Avery 8460";
const char PageSetup::strCILS[]        = "CILS ALP1-9200-1";
    ...
    : QDialog(parent)
{
    ...
    comboLabelType->addItem(tr("Avery 5263"), QString(strAvery5263));
    comboLabelType->addItem(tr("Avery 5264"), QString(strAvery5264));
    comboLabelType->addItem(tr("Avery 8460"), QString(strAvery8460));
    comboLabelType->addItem(tr("Avery 8460"), QString(strAvery8460));
    comboLabelType->addItem(tr("CILS ALP1-9200-1"), QString(strCILS));
}
