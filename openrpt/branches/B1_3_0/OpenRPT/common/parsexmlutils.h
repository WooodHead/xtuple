...
class ORSectionData
{
  public:
    ...
    QPtrList<ORObject> objects;
    QValueList<ORDataData> trackTotal;
};
...
class ORDetailSectionData
{
  public:
    ...
    QValueList<ORDetailGroupSectionData*> groupList;
    QValueList<ORDataData> trackTotal;
};
...
class ORParameter
{
  public:
    ...
    QString listtype;
    QString query;
    QValueList<QPair<QString,QString> > values;
    bool active;
};
...
class ORReportData
{
  public:
    ...
    QPtrList<ORDetailSectionData> sections;
