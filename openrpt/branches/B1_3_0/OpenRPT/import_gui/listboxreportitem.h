...
class ListBoxReportItem : public QListBoxText
{
  public:
    ListBoxReportItem(const QString & name, int grade = 0);
    ListBoxReportItem(QListBox * listbox, const QString & name, int grade = 0);
    ListBoxReportItem(QListBox * listbox, const QString & name, int grade, QListBoxItem * after);
