This package is for xtdesktop, a supplemental extension package for xTuple ERP that provides a graphical presentation of commonly used menu items and quick reference lists of critical data.  The following items are perquisites for using this extension:
