...
BEGIN
  ...
  ( bomitem_parent_item_id, bomitem_seqnumber,
    ...
    bomitem_booitem_id, bomitem_schedatwooper, bomitem_moddate, bomitem_rev_id )
  SELECT bomitem_parent_item_id, bomitem_seqnumber,
         ...
         bomitem_booitem_id, bomitem_schedatwooper, CURRENT_DATE, getActiveRevId(''BOM'',bomitem_parent_item_id)
  FROM bomitem
