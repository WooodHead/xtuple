...
--  March through the non-misc invcitems
  FOR _r IN SELECT invcitem.*,
                   itemsite_id, item_id,
                   item_invpricerat, stdCost(item_id) AS cost
...
--  Cache the amount due for this line
    _amount := round((_r.invcitem_billed * _r.invcitem_price / _r.item_invpricerat), 2);
...
--  Record Sales History for this S/O Item
    ...
    ( _p.invchead_cust_id, _r.itemsite_id, _p.invchead_shipto_id, _r.invcitem_tax_id,
      ...
      _r.invcitem_billed, (_r.invcitem_price / _r.item_invpricerat), _r.cost,
      _p.invchead_salesrep_id, (_p.invchead_commission * _r.invcitem_billed * _r.invcitem_price / _r.item_invpricerat), FALSE,
