...
--  Distribute A/R Applications
  ...
  --  Determine discount percentage
    SELECT CASE WHEN (CURRENT_DATE <= (aropen_docdate + terms_discdays)) THEN terms_discprcnt
            ELSE 0.00
            END INTO _discprcnt
  ...
  --  proportional tax credits calculated and implemented for the credit memo generated by the discount
    ...
    _comment := ('CM for ' || _p.cashrcpt_docnumber);
  ...
  --  Create credit memo for discount
      SELECT createARCreditMemo(_r.aropen_id, _p.cashrcpt_cust_id, _arMemoNumber, '',
