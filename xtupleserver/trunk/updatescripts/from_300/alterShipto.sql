...
ALTER TABLE shiptoinfo DISABLE TRIGGER shiptoinfoaftertrigger;
...
DELETE FROM shiptoinfo WHERE shipto_cust_id NOT IN
...
ALTER TABLE shiptoinfo ENABLE TRIGGER shiptoinfoaftertrigger;
