...
SELECT cohist.*,
       ...
       xmoney(cohist_qtyshipped * cohist_unitprice) AS extprice,
       xmoney(cohist_qtyshipped * currtobase(cohist_curr_id, cohist_unitprice, cohist_invcdate)) AS baseextprice,
       xmoney(cohist_qtyshipped * currtocurr(cohist_curr_id, cust_curr_id, cohist_unitprice, cohist_invcdate)) AS custextprice,
       ...
       'cost'::TEXT AS extcost_xtnumericrole,
