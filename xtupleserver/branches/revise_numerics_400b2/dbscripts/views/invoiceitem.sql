...
SELECT invcitem.*, itemsite_id, cohead_number,
       ...
       COALESCE((invcitem_price / invcitem_price_invuomratio), xsalep(0)) AS unitprice,
       COALESCE((invcitem_billed * invcitem_qty_invuomratio) *
                (invcitem_price / invcitem_price_invuomratio), xsalep(0)) AS extprice,
       currToBase(invchead_curr_id,
                  COALESCE((invcitem_billed * invcitem_qty_invuomratio) *
                           (invcitem_price / invcitem_price_invuomratio), xsalep(0)),
